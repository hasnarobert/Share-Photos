...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <fieldset class="register">
        ...
        <p>
            <asp:Label ID="realNameLanel" runat="server" AssociatedControlID="realName">Real Name: </asp:Label>
            <asp:TextBox ID="realName" runat="server" CssClass="textEntry"></asp:TextBox>
       </p>
       <p>
